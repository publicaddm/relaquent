...
use Publica\Relaquent\Relations\Concerns\BelongsToTrait;
...
class MorphTo extends IlluminateMorphTo
{
    ...
    {
        return $this->parent->isDirty([$this->foreignKey, $this->morphType]);
    }
    ...
    public function toBelongsToMorph(string $related, string $ownerKey = null): BelongsToMorph
    {
        ...
        return new BelongsToMorph($instance->newQuery(), $this->parent, $this->morphType,
            $this->foreignKey, $ownerKey, $this->relation);
    }
}
